...
WebUI.click(findTestObject('Object Repository/Orange HRM/Page_OrangeHRM/b_Admin'))

WebUI.setText(findTestObject('Object Repository/Orange HRM/Page_OrangeHRM/input_Username_searchSystemUseruserName'), 'Debojeet')

WebUI.click(findTestObject('Object Repository/Orange HRM/Page_OrangeHRM/b_Directory'))
